...
@props([
    ...
    <div class="col-4  text-center">
        <label  for="" class="mb-2">{{ __('PFBS.year') }}  </label>
        <select  name="{{$nameYear}}" id="" wire:model="{{$nameYear}}"
            class="form-select @error('{{$nameYear}}') is-invalid @enderror" required>
    ...
    <div class="col-4   text-center">
        <label for="" class="mb-2">{{ __('PFBS.month') }}</label>
    ...
    <div class="col-4   text-center">
        <label for="" class="mb-2">{{ __('PFBS.day') }}</label>
